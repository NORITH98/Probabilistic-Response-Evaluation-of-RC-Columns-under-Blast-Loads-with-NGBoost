...
# Custom decision tree regressor definition
...
param_grid = {
    'Base__max_depth': [2,4,6,8,10],
    'Base__min_samples_split': [2, 4, 6, 8, 10],
    'Base__min_samples_leaf': [1, 3, 5, 7, 9],
    'n_estimators': [300,340,380,420,460,500],
    'learning_rate': [0.01, 0.05, 0.1, 0.15, 0.2]
}


ngb = NGBRegressor(Dist=Normal, verbose=False, Base=CustomDecisionTreeRegressor())
